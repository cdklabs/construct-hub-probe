...
| <code><a href="#construct-hub-probe.SampleRepository.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="construct-hub-probe.SampleRepository.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="construct-hub-probe.SampleRepository.with.parameter.mixins"></a>
